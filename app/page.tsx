		...
		<>
			<section className="bg-background py-16 lg:py-24 relative">
				...
				<Container className="grid grid-cols-1 lg:grid-cols-2 gap-16">
					{/* Text Section */}
					<div className="flex flex-col gap-y-12 my-auto z-10">
						<h1 className="text-center lg:text-left text-5xl lg:text-6xl leading-tight font-extrabold text-foreground relative">
						...
						<p className="text-center lg:text-left text-xl text-foreground leading-normal">
						...
						<div className="flex flex-col items-center lg:flex-row lg:justify-start gap-x-8 gap-y-12">
				...
				<Container>
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-12">
						<div className="relative lg:col-span-1">
							<h2 className="text-4xl lg:text-5xl font-bold text-foreground leading-tight mb-5 lg:mb-0">
								I'm your{" "}
			...
			<section className="bg-background py-16 lg:py-24">
				<div className="container mx-auto">
					<div className="text-center mb-12">
						...
						<p className="mt-5 text-lg lg:text-xl text-foreground mx-auto max-w-md leading-normal">
				...
				<div className="container mx-auto">
					<div className="text-center mb-12">
						<h2 className="max-w-2xl mx-auto text-5xl font-bold text-foreground">
							<span className="text-orange-500">Thoughts</span> on design, business, and
							indie-hacking
						</h2>
					</div>
