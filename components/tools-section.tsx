...
interface ToolsSectionProps {
	readonly tools: typeof config.tools;
}
	...
	return (
		<section className="bg-background py-16">
			<div className="container mx-auto">
				<TypographyH3 className="text-center mb-8">The tools I use on my day-to-day</TypographyH3>
				...
				<div className="overflow-x-auto">
					<div className="flex space-x-8 justify-center items-center flex-wrap">
						{tools.map((tool) => (
							...
							>
								<Image src={tool.logo} alt={`${tool.name} logo`} width={32} height={32} />
							</div>
						))}
					</div>
				</div>
